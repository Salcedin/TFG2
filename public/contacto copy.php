...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt = $conn->prepare($sql)) {
        ...
        // Ejecuta la consulta
        if ($stmt->execute()) {
            echo "<script>alert('Consulta enviada con éxito.'); window.location.href='index.php';</script>";
        } else {
    ...
    <div id="chatbot" class="chatbot-container" style="display: none;">
        ...
        <div class="chatbot-footer">
            ...
            <button class="quick-reply"
                onclick="sendMessage('Me gustaría ayudar a desarrollar la plataforma en futuras actualicaciones, ¿cómo puedo hacerlo?')">Me
                gustaría ayudar a desarrollar la plataforma en futuras actualicaciones, ¿cómo puedo hacerlo?</button>
        </div>
    </div>
